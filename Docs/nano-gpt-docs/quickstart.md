# Quickstart - NanoGPT API Documentation
...
For more advanced web search capabilities including structured output, domain filtering, and date filtering, see the [Web Search API](/api-reference/endpoint/web-search).Check out our [Chat Completion Guide](/api-reference/endpoint/chat-completion) for more examples.
...
[Introduction](/introduction)[Models](/api-reference/endpoint/models)
