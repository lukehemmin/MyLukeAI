# Pricing and Fees - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/miscellaneous/pricing
...
For full pricing per model see our [dedicated pricing page](https://nano-gpt.com/pricing) with all models listed. We do not charge any minimum fee per query, nor do we charge any fee on deposits. If you are (potentially) going to be a large user of our API reach out to us at [[email protected]](/cdn-cgi/l/email-protection#176462676778656357797679783a7067633974787a) or our [Discord](https://discord.gg/KaQt8gPG6V) for a discount.

[Rate Limits](/api-reference/miscellaneous/rate-limits)[For Providers](/api-reference/miscellaneous/for-providers)
