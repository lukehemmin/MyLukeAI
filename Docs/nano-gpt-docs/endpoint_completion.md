# Completions - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/endpoint/completion
...
[Chat Completion](/api-reference/endpoint/chat-completion)[Embeddings](/api-reference/endpoint/embeddings)
