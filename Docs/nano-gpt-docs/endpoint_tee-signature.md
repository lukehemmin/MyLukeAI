# TEE Signature - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/endpoint/tee-signature
...
[TEE Attestation](/api-reference/endpoint/tee-attestation)[Retrieve Midjourney Generation Status](/api-reference/endpoint/check-midjourney-status)
