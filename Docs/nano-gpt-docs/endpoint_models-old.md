# Models (Old) - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/endpoint/models-old
...
[Personalized Models](/api-reference/endpoint/personalized-models)[Chat Completion](/api-reference/endpoint/chat-completion)
