# Text-to-Speech (TTS) - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/text-to-speech
...
On this page
  ...
  * [Simple TTS Request](#simple-tts-request)
  * [Async Status & Polling](#async-status-%26-polling)
  * [Model-Specific Examples](#model-specific-examples)
  * [Kokoro-82m - Multilingual Voices](#kokoro-82m-multilingual-voices)
  * [Elevenlabs-Turbo-V2.5 - Premium Quality with Controls](#elevenlabs-turbo-v2-5-premium-quality-with-controls)
  * [OpenAI Models - Multiple Formats and Instructions](#openai-models-multiple-formats-and-instructions)
  * [Complete TTS Class Implementation](#complete-tts-class-implementation)
  * [Best Practices and Tips](#best-practices-and-tips)
  * [Character Limits and Costs](#character-limits-and-costs)
...
[Speech-to-Text (STT)](/api-reference/speech-to-text)[TEE Verification](/api-reference/tee-verification)
