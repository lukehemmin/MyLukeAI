# TEE Verification - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/tee-verification
...
On this page
  ...
  * [Overview](#overview)
  * [Fetch Attestation Report](#fetch-attestation-report)
  * [Fetch ECDSA Signature](#fetch-ecdsa-signature)
...
[Text-to-Speech (TTS)](/api-reference/text-to-speech)[Teams](/api-reference/teams)
