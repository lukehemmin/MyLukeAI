# Rate Limits - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/miscellaneous/rate-limits
...
The NanoGPT API currently imposes a limit of 25 requests per second. If you need a higher limit than this reach out to us at [[email protected]](/cdn-cgi/l/email-protection#d1a2a4a1a1bea3a591bfb0bfbefcb6a1a5ffb2bebc) and let us know what model(s) and roughly what capacity you would need. If your usecase requires more than 1 billion tokens daily of a specific model, reach out to us at [[email protected]](/cdn-cgi/l/email-protection#0a797f7a7a65787e4a646b6465276d7a7e24696567). It should be no problem, but we might be able to offer a discount. If rate limits are implemented in the future, this documentation will be updated accordingly.

[Teams](/api-reference/teams)[Pricing and Fees](/api-reference/miscellaneous/pricing)
