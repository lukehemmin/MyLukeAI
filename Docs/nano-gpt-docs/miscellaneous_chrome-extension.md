# Chrome Extension - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/miscellaneous/chrome-extension
...
Information about the NanoGPT Chrome Extension
...
[Auto Recharge](/api-reference/miscellaneous/auto-recharge)[JavaScript Library](/api-reference/miscellaneous/javascript)
