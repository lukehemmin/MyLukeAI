# TEE Attestation - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/endpoint/tee-attestation
...
[TTS Status](/api-reference/endpoint/tts-status)[TEE Signature](/api-reference/endpoint/tee-signature)
