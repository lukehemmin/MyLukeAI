# Receive Nano - NanoGPT API Documentation

**Source:** https://docs.nano-gpt.com/api-reference/endpoint/receive-nano
...
[Subscription Usage](/api-reference/endpoint/subscription-usage)[Crypto Deposits](/api-reference/endpoint/crypto-deposits)
