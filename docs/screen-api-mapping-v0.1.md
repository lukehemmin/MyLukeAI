...
- `ADMIN-07-14 Pipelines` -> category settings API + `GET /api/admin/pipelines`, `POST /api/admin/pipelines/upload`, `POST /api/admin/pipelines/install-from-url`, `PATCH /api/admin/pipelines/{id}`, `POST /api/admin/pipelines/{id}/enable`, `POST /api/admin/pipelines/{id}/disable`, `GET /api/admin/pipelines/{id}/logs`
